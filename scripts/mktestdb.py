...
if __name__ == '__main__':
    parser = ArgumentParser(description="Script to create a test CRMP database and write it to a test database (probably sqlite). DSN strings are of form:\n\tdialect+driver://username:password@host:port/database\nExamples:\n\tpostgresql://scott:tiger@localhost/mydatabase\n\tpostgresql+psycopg2://scott:tiger@localhost/mydatabase\n\tpostgresql+pg8000://scott:tiger@localhost/mydatabase")
    ...
    parser.add_argument("-t", "--testdsn", help="Destination DSN to write to",
                        default='sqlite+pysqlite:////tmp/crmp.sqlite')
