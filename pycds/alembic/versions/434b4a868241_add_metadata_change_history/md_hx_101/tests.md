...
BEGIN
    ...
    CREATE TRIGGER t100_primary_ops_to_hx
        ...
        ON a
        FOR EACH ROW
    EXECUTE FUNCTION mdhx_primary_control_hx_cols();
    ...
    CREATE TABLE a_hx (
        ...
        creator character varying(64) COLLATE pg_catalog."default" NOT NULL DEFAULT CURRENT_USER,
        -- History columns
        a_hx_id INTEGER PRIMARY KEY, -- $2 (new_metadata_hx_id)
        deleted BOOLEAN NOT NULL DEFAULT FALSE  -- $3 (deleted)
    ...
    CREATE TABLE b_hx (
        ...
        creator character varying(64) COLLATE pg_catalog."default" NOT NULL DEFAULT CURRENT_USER,
        -- History columns
        b_hx_id INTEGER PRIMARY KEY, -- $2 (new_metadata_hx_id)
        deleted BOOLEAN NOT NULL DEFAULT FALSE, -- $3 (deleted)
        -- Foreign key columns. 
